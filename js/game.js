...
function begin(elem) {
	...
	test.innerHTML = 
		'<div class="grid">'+
			'<div id = "b1" class="Asherog">Asherog - Destroyer<img src="img/Asherog.jpg"></div>'+
			'<div id = "b2" class="Arka">Arka - Scholar<img src="img/Arka.jpg"></div>'+
			'<div id = "b3" class="Astren">Astren - Creator<img src="img/Astren.jpg"></div>'+
			'<div id = "b4" class="Benusi">Benusi - Trucker<img src="img/Benusi.jpg"></div>'+
			'<div id = "b5" class="Buzari">Buzari - Merchant<img src="img/Buzari.jpg"></div>'+
			'<div id = "b6" class="Charn">Charn - Telepath<img src="img/Charn.jpg"></div>'+
			'<div id = "b7" class="Leonid">Leonid - Slaver<img src="img/Leonid.jpg"></div>'+
			'<div id = "b8" class="Rachnian">Rachnian - Pirate<img src="img/Rachnian.jpg"></div>'+
			'<div id = "b9" class="Suronian">Suronian - Warrior<img src="img/Suronian.jpg"></div>'+
			'<div id = "b10" class="Thuvix">Thuvix - Mechanic<img src="img/Thuvix.jpg"></div>'+
		'</div>';
